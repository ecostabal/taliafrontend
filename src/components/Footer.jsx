                ...
                <nav className="-mb-6 columns-2 text-center sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
                    {navigation.main.map((item) => (
                        <div key={item.name} className="pb-6">
                            <Link to={item.to} className="text-sm font-reddit leading-6 text-gray-600 hover:text-gray-900">
                                {item.name}
                            </Link>
                        </div>
                    ))}
                </nav>
                <p className="mt-10 text-center font-reddit text-xs leading-5 text-gray-500">
