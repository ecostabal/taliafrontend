      ...
      >
                  ...
                  {products.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-auto">
                        <a
                          href={item.href}
                          className="block font-reddit font-semibold text-zinc-800"
                        >
                          {item.name}
                          {item.soon && (
                        ...
                        <p className="mt-1 font-reddit font-light text-gray-600">
                          {item.description}
                        </p>
                      </div>
                    </div>
            ...
            >
              <Popover.Panel className="absolute -left-8 top-full z-10 mt-3 w-96 rounded-md bg-white p-4 shadow-lg ring-1 ring-zinc-800/5">
                {company.map((item) => (
                  <div
                    key={item.name}
                    className="relative rounded-lg p-4 font-reddit font-light hover:bg-gray-50"
                  >
                    <a
                      href={item.href}
        ...
        <div className="hidden lg:flex lg:flex-1 lg:justify-end">
          <a
            ...
            className="border border-zinc-800 bg-blue-500 px-4 py-2 font-reddit text-sm leading-6 text-white transition-all duration-300 ease-in-out hover:border-zinc-800 hover:bg-blue-500"
                ...
                <div className="mt-12 space-y-2 py-6 sm:hidden">
                  {products.map((item) => (
                    <a
                      key={item.name}
                      href={item.href}
                      className="group -mx-3 flex items-center gap-x-6 rounded-lg p-3 font-reddit text-base font-light leading-7 text-zinc-800 hover:bg-gray-50"
                    >
                      <img
                        src={item.icon}
                        className="h-8 w-8"
