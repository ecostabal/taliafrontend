      ...
      <div className="flow-root bg-white pb-24 sm:pb-32">
        <div className="-mt-80">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="grid max-w-md grid-cols-1 gap-8 sm:mx-64 lg:max-w-4xl">
              {tiers.map((tier) => (
                <div
                  key={tier.id}
                  className="flex flex-col justify-between rounded-md bg-white p-8 shadow-xl sm:p-10"
                >
                  <div>
                    <h3
                      id={tier.id}
                    ...
                    <p className="text-md mt-6 text-center font-reddit leading-7 text-zinc-600">
                      {tier.description}
                    </p>
                  ...
                  <p className="mt-4 text-center font-reddit text-xs text-zinc-400">
