export default function AboutUs() {
  return (
    <div className="bg-white pb-16 pt-24 sm:pb-24 sm:pt-32 xl:pb-32">
      <div className="relative bg-gray-900 pb-20 sm:pb-24 xl:pb-0">
          ...
          <div className="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:px-16 xl:py-24">
            <figure className="relative isolate pt-6 sm:pt-12">
              <blockquote className="font-reddit text-xl font-semibold leading-8 text-white sm:text-2xl sm:leading-9">
                <p>
                  Talia Abogados es un estudio jurídico conformado por
                  destacados abogados e ingenieros, unidos con la misión de
                  brindar asesoría legal integral adaptada a los tiempos
                  actuales, donde la tecnología es un factor clave para contar
                  con un flujo eficiente de trabajo con tus abogados internos o
                  externos. Entre nuestros clientes destacan estudios jurídicos,
                  fiscalías de empresas, abogados independientes, entre otros.
                </p>
              </blockquote>
            </figure>
          </div>
