    ...
    <div className="mx-auto max-w-6xl px-6 pb-24 pt-12 xl:px-0 xl:pb-48 xl:pt-24">
      <div className="grid grid-cols-1 items-center gap-32 lg:grid-cols-2">
        <div className="space-y-12">
          ...
          <p className="font-reddit">
            Somos un <span className="font-semibold">Estudio Jurídico</span> que
            combina{" "}
            <span className="font-semibold">
              desarrollo de softwares y asesoría legal especializada.
            </span>
          </p>
          <div className="flex items-center gap-4">
            <Link
              to={RoutePaths.DEMOLEAD}
              className="sm:text-md flex items-center justify-center border border-zinc-800 bg-blue-500 px-8 py-4 font-reddit text-sm text-white transition-all duration-300 ease-in-out hover:bg-blue-500"
