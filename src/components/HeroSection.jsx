...
export default function HeroSection() {
  return (
    <div className="mx-auto max-w-6xl py-24 sm:pb-48 px-6 xl:px-0">
        ...
        <div className="space-y-12">
          ...
          <div className="flex items-center gap-4">
            <Link
              ...
              className="text-md flex items-center justify-center rounded-full border border-zinc-800 p-3 font-lora text-zinc-800 transition-all duration-300 ease-in-out hover:bg-blue-500 w-52 lg:p-4"
            ...
            <a
              href="/"
              className="text-md flex items-center justify-center rounded-full border border-white p-3 font-lora text-zinc-800 transition-all duration-300 ease-in-out hover:text-blue-500 lg:p-4"
            >
              Ver Tutorial
